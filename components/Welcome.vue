<template>
  <div class="max-w-5xl mx-auto px-5 mt-5">
    ...
    <p>
      nuxt-user also supports server side sessions. You can find the full documentation for this <a href="https://github.com/sidebase/nuxt-user#server-side-usage" target="_blank">here</a>.
    </p>
    <hr class="my-5" />
  </div>
</template>
